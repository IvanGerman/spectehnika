...
export const description = {
  ...
  uborka: 'Очисткой от снега занимаются опытные водители, наша техника всегда готова к работе.Снег убирается с вашей территории с помощью погрузчика и самосвала и отвозится на специальный  полигон.',

  demontazh: 'Для нас не представляет сложности кирпичная кладка, бетонные строения, смешанные конструкции. После сноса дома/ здания / стены/ подсобного строения  на участке остаётся строительный мусор, наша компания может также помочь вам с вывозом утилизацией любого строительного мусора и последующей планировкой освободившихся площадей.',
  
  kopka: 'Наши экскаваторы работают в  Томске и Северске, в пригородах Томска.  Спецтехнику используют для устройства фундамента, рытья котлована в грунте, копки траншей. У наших специалистов есть необходимый опыт в проведении данного вида работ, обращайтесь!'
